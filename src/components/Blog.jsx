          ...
          {posts
            ...
            .map((post) => (
              <motion.article
                ...
                initial="hidden"
                animate={inView ? 'visible' : 'hidden'}
                className="group card-dark overflow-hidden lg:row-span-2 flex flex-col"
              >
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-espresso-border mt-auto">
                    ...
                    <Link
                      to={`/blog/${post.slug}`}
                      className="text-espresso-red text-xs tracking-wider uppercase font-sans font-semibold flex items-center gap-2 group-hover:gap-3 transition-all duration-300"
                    >
            ...
            {posts
              ...
              .map((post, i) => (
                <motion.article
                  ...
                  initial="hidden"
                  animate={inView ? 'visible' : 'hidden'}
                  className="group card-dark overflow-hidden flex"
                >
                  ...
                  <div className="p-6 flex flex-col justify-between flex-1">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-espresso-border">
                      ...
                      <Link
                        to={`/blog/${post.slug}`}
                        className="text-espresso-red text-[10px] tracking-wider uppercase font-sans font-semibold flex items-center gap-1 group-hover:gap-2 transition-all duration-300"
                      >
